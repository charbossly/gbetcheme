(function main() {
  ...
  function TranslateButton_Translate() {
    ...
    url = "https://cb90-41-216-49-138.ngrok-free.app/text/text";
    fetch(url, {
      method: "POST",
      headers: {
      ...
      .then((json) => {
        ...
        this._ntext.innerText = json.translation;
        this.onclick();
      });
  }
  ...
  function TranslateButton(main) {
    ...
    tb._otext.addEventListener("DOMSubtreeModified", (_) =>
    ...
    tb._ntext.classList =
      "style-scope ytd-comment-renderer translate-text yt-formatted-string";
  ...
  /* Query Selectors */
  // From main
  const QS_TRANSLATE_BUTTON =
    "#header>#header-author>yt-formatted-string>#translate-button, #header>#header-author>#published-time-text>#translate-button";
  const QS_CONTENT_TEXT = "#expander>#content>#content-text";
  const QS_BUTTON_CONTAINER =
    "#header>#header-author>yt-formatted-string, #header>#header-author>#published-time-text";

  /* User settings */
  var TRANSLATE_TEXT = "traduire",
    UNDO_TEXT = "retour",
    //TARGET = navigator.language || navigator.userLanguage;
    TARGET = "yoruba";
        ...
        /*if (mut.target.tagName.toLowerCase() == "ytd-comments") {
          ...
          for (let n of mut.addedNodes) {
            ...
            if (tb != null) {
              ...
              main
                .querySelector(QS_BUTTON_CONTAINER)
                .appendChild(TranslateButton(main));
            }
          }
        }
      }
