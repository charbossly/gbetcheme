...
export const apiKeyAtom = atom<any>(process.env.OPENAI_API_KEY)

// TRANSCRIBE
export const fileNameAtom = atom<string>("")
export const fileTypeAtom = atom<"vtt" | "srt">("vtt")
export const inputTypeAtom = atom<any>("")
export const inputSizeAtom = atom<any>("")
export const inputPathAtom = atom<any>("")
export const videoBlobAtom = atom<any>("")
export const imgUrlAtom = atom<any>("")
...
export const tokenSizeAtom = atom((get) => {
